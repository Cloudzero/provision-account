...
This is a sample template for discovery - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name discovery --tail
```
...
```bash
aws cloudformation delete-stack --stack-name discovery
```
